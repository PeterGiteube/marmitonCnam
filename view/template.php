...
<script src="<?= $this->getIndex() . '/public/js/jquery.js' ?>"></script>
<script src="<?= $this->getIndex() . '/public/js/popper.js' ?>"></script>
...
<script src="<?= $this->getIndex() . '/public/js/bootstrap.js' ?>"></script>
</html>